...
@ActionID(
        category = "MyActions",
        id = "de.markiewb.netbeans.sample.DeactivatedPopupAction"
)
@ActionRegistration(
        displayName = "#CTL_DeactivatedPopupAction", lazy = false
)
@ActionReferences({
    @ActionReference(path = "Projects/Actions")
})
@Messages("CTL_DeactivatedPopupAction=I am a submenu, which can be disabled")
public final class DeactivatedPopupAction extends AbstractAction implements ActionListener, Presenter.Popup {

    private final Lookup.Result<Project> result;
    private final transient LookupListener lookupListener;

    public DeactivatedPopupAction() {
        putValue(NAME, Bundle.CTL_DeactivatedPopupAction());
            ...
            public void resultChanged(LookupEvent ev) {
                final Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        DeactivatedPopupAction.this.setEnabled(s == 2);
                    }
                };
